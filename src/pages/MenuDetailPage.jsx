...
import { Clock, MapPin, Star, Phone, Utensils, Heart, AlertTriangle, MessageSquare, ChevronDown, CheckCircle, Save, X } from 'lucide-react';
...
const mockMenuData = {
  'buddha-bowl': {
    ...
    rating: 4.8,
    reviews: 125,
    description: "Bowl sehati dengan Quinoa organik, campuran sayuran segar, alpukat, buncis, chickpeas, dan dressing tahini lemon mustard. Rasanya ringan, menyegarkan, dan sangat mengenyangkan.",
    ...
    ingredients: [
      'Quinoa Organik', 'Baby Spinach', 'Tomat Cherry', 'Alpukat', 'Buncis Rebus', 'Tahini Dressing', 'Lemon Mustard'
    ],
    cookingMethod: 'Semua bahan disajikan mentah/rebus, dressing dibuat tanpa gula tambahan.',
        ...
        <div className="p-6 max-h-[80vh] overflow-y-auto">
          ...
          <div className="mt-4 p-4 bg-green-50 rounded-xl border-l-4 border-green-500">
            <div className="flex items-center gap-2 text-green-700 font-semibold mb-2">
                <CheckCircle size={20} />
                <span>Verifikasi RasoSehat</span>
            </div>
            <p className="text-sm text-gray-700">
              Menu ini telah diverifikasi oleh tim kami (berdasarkan literatur bahan dan metode masak) dan memenuhi kriteria **Rendah Kolesterol** dan **Seimbang**.
            </p>
          </div>
        </div>
      </motion.div>
...
export default function MenuDetailPage() {
  ...
  if (!menu) {
    return (
      <div className="min-h-screen pt-28 text-center p-8">
        ...
        <p className="text-gray-600 mt-4">Maaf, menu dengan ID {slug} tidak dapat ditemukan. Kembali ke <Link to="/" className="text-green-600 hover:underline">Beranda</Link>.</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white pt-24 md:pt-28 pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          >
            ...
            <div className="mt-8 bg-white rounded-2xl p-6 shadow-xl border border-gray-100">
                ...
                <p className="text-base font-semibold text-gray-700 mb-2">{menu.restaurant.name}</p>
                <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 text-gray-600">
                        ...
                        <p className="text-sm font-semibold">Buka (Tutup jam 21:00)</p> {/* Mock Status */}
                    </div>
                </div>
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <button
                        className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-colors duration-300 hover:scale-[1.01]"
                    >
          ...
          >
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <MessageSquare className="w-6 h-6 text-green-500"/> Penilaian Produk
              </h2>
              <div className="bg-gray-50 rounded-xl p-4 shadow-inner">
                ...
                <div className="p-4 bg-white rounded-lg shadow-sm">
                    <p className="text-gray-800 italic mb-2">"Gila, makanannya juara banget! Rasanya nendang di lidah, bumbunya meresap sempurna. Porsinya juga pas, bikin kenyang tapi nggak eneg. Cocok buat yang doyan makan tapi pengen yang gak ribet. Wajib coba deh, dijamin ketagihan!"</p>
                    <p className="text-xs text-gray-500 mt-2">N******k* | 1 minggu lalu</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <AnimatePresence>
        {showNutritionModal && (
          <NutritionModal data={menu.nutrition} onClose={() => setShowNutritionModal(false)} />
        )}
      </AnimatePresence>
    </div>
  );
